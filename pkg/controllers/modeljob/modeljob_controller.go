...
import (
	...
	cleverv1alpha1 "github.com/caicloud/ormb/pkg/apis/v1alpha1"
)
...
// +kubebuilder:rbac:groups=clever.caicloud.io,resources=modeljobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=clever.caicloud.io,resources=modeljobs/status,verbs=get;update;patch
